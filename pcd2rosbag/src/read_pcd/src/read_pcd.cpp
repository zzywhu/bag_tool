...
int main (int argc, char **argv)
{
  ...
  pcl::PointCloud<pcl::PointXYZ> cloud;
  sensor_msgs::PointCloud2 output;
  string path = "/home/zzy/bag_tool/data/LIdar and Trajectory data (copy)/";
  string bagname = "/home/zzy/bag_tool/data/LIdar and Trajectory data (copy)/out.bag";
